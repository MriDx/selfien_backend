...
const POST_ACTIVITY_TYPE = ['COMMENT' => 'comment', 'LIKE' => 'like', 'DISLIKE' => 'dislike', 'FOLLOW' => 'follow', 'FAVORITE' => 'favorite', 'UNFAVORITE' => 'unfavorite'];
...
return [
    ...
    'POST_ACTIVITY_FAVORITE' => POST_ACTIVITY_TYPE['FAVORITE'],
    'POST_ACTIVITY_UNFAVORITE' => POST_ACTIVITY_TYPE['UNFAVORITE'],
    ...
    'enums' => [
        ...
        'post_activities' => [POST_ACTIVITY_TYPE['COMMENT'], POST_ACTIVITY_TYPE['LIKE'], POST_ACTIVITY_TYPE['DISLIKE'], POST_ACTIVITY_TYPE['FAVORITE']],
